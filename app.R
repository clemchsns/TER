...
data_base <- read.csv("Data/NBA_Season_Data.csv", header=TRUE, stringsAsFactors=TRUE,sep=",",dec=".")
...
data_players <- read.csv("Data/players.csv", header=TRUE, stringsAsFactors=TRUE,sep=",",dec=".")
...
ui <- dashboardPage(
    ...
    .tabbable > .nav > li > a {background-color: #32444F ; color:white}")),
            ...
            tabItem(tabName="dunks", 
                    fluidPage(HTML("<h1 style=\"color : white ; background-color : lightgrey ; text-align : center ; border-radius : 10px\">Dix dunks impressionnants !</h1>"), HTML('<p align="center"><iframe width="560" height="315" src="https://www.youtube.com/embed/uVuYt7mJIfc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>'))
            ),
            tabItem("Clubs",
