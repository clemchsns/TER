...
data_base <- read.csv("NBA_Season_Data.csv", header=TRUE, stringsAsFactors=TRUE,sep=",",dec=".")
...
data_players <- read.csv("players.csv", header=TRUE, stringsAsFactors=TRUE,sep=",",dec=".")
