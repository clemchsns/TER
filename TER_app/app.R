        ...
        tabItems(
            ...
            tabItem("Clubs",
                    tabsetPanel( #diviser le tableau principal en onglets
                        ...
                        tabPanel('Régression',selectizeInput('var_reg','Choisissez une variable à expliquer',choices=names(list(data_equipe))),selectizeInput('var_explicative','Choisissez une variable explicative',choices=names(list(data_equipe)))),
